-- MIGRATION 46: Enable ERP Reservations
-- Description: Updates registrar_venta_atomica to accept delivery_date and handle stock reservation logic.
...
CREATE OR REPLACE FUNCTION registrar_venta_atomica(
    ...
    p_customer_id uuid,
    p_product_name text,
    p_delivery_date date DEFAULT NULL -- New parameter with default
)
RETURNS jsonb
LANGUAGE plpgsql
SECURITY DEFINER
