-- MIGRATION 42: Fix Web Order RPC UUID Types
-- Description: Updates registrar_pedido_web_v3 to correct product ID type from bigint to uuid.
...
DECLARE
    ...
    v_price numeric;
    v_subtotal numeric;
    v_product_id uuid; -- CHANGED: bigint -> uuid
...
BEGIN
    ...
    LOOP
        v_product_id := (v_item->>'id')::uuid; -- CHANGED: casting to uuid
