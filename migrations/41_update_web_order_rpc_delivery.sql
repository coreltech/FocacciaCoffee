-- MIGRATION 41: Update Web Order RPC for Pre-Orders
-- Description: Updates registrar_pedido_web_v3 to skip stock validation if a delivery_date is provided.
...
DECLARE
    ...
    v_delivery_date date; -- NEW: Delivery Date
...
BEGIN
    ...
    LOOP
        ...
        INSERT INTO sales_orders (
            ...
            now(),
            v_delivery_date, -- Store the promise date
            v_customer_id,
            v_subtotal,
            0,
            'Pendiente',
