    ...
    renderLayout(container, supplies, subRecipes) {
        ...
        <div class="main-container fade-in">
            <header style="margin-bottom: 25px; display: flex; justify-content: space-between; align-items: center;">
                <div>
                    <h1>👩‍🍳 Recetas Profesionales</h1>
                    <p style="color: #64748b;">Manejo de fórmulas panaderas, porcentajes y márgenes de contribución.</p>
                </div>
                <div style="display: flex; gap: 10px;">
                    <button id="btn-new-recipe" class="btn-primary">+ Nueva Receta</button>
                </div>
            </header>

            <div style="display: grid; grid-template-columns: 1fr; gap: 30px;" id="recipe-workspace">
                <!-- LISTADO (Default) -->
                <div id="recipe-list-container" class="stat-card">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
                        <h3>Catálogo de Recetas</h3>
                        <input type="text" id="search-recipe" placeholder="🔎 Buscar receta..." class="input-field" style="width: 250px;">
                    </div>
                ...
                <div id="recipe-form-container" class="stat-card" style="display: none;">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                        <h2 id="form-title">Nueva Receta</h2>
                        <button id="btn-close-form" style="background:none; border:none; cursor:pointer; font-size:1.5rem;">✕</button>
                    </div>
                    ...
                    <div style="display: grid; grid-template-columns: 2fr 1fr 1fr; gap: 15px;">
                        ...
                        <div class="input-group">
                            <label>Peso Final Esperado (g)</label>
                            <input type="number" id="recipe-expected-weight" class="input-field" placeholder="Ej. 5000">
                        </div>
                    </div>

                    <div id="bakers-base-section" style="margin-top: 20px; padding: 15px; background: #f0f9ff; border-radius: 8px; border: 1px solid #bae6fd;">
                        <div style="display: flex; align-items: center; gap: 15px;">
                            <div style="font-size: 1.2rem;">⚖️</div>
                            <div style="flex: 1;">
                                <label style="font-weight: bold; color: #0369a1;">Peso de Harina Base (100%) para el cálculo</label>
                                <div style="display: flex; gap: 10px; margin-top: 5px;">
                                    <input type="number" id="base-flour-weight" class="input-field" value="1000" style="width: 150px;">
                                    <span style="align-self: center; font-weight: bold; color: #0369a1;">gramos</span>
                                </div>
                            </div>
                            <div style="text-align: right;">
                                <div style="font-size: 0.75rem; color: #0369a1;">Peso Total de Mezcla:</div>
                                <div id="total-mix-weight" style="font-size: 1.1rem; font-weight: bold;">0 g</div>
                            </div>
                        </div>
                    </div>

                    <div style="margin-top: 25px;">
                        <h3>Ingredientes y Porcentajes</h3>
                        <div style="display: grid; grid-template-columns: 2fr 1fr 1fr 1fr auto; gap: 10px; margin-top: 10px; align-items: end;">
                            <div class="input-group">
                                <label>Insumo / Sub-Receta</label>
                            ...
                            <div style="display: flex; align-items: center; padding-bottom: 12px;">
                                <input type="checkbox" id="item-is-base" style="margin-right: 8px;"> 
                                <label for="item-is-base" style="font-size: 0.8rem; cursor: pointer;">Es Base (100%)</label>
                            </div>
                            <button id="btn-add-item" class="btn-primary" style="margin-bottom: 5px; height: 38px;">+</button>
                        </div>
                    ...
                    <div style="margin-top: 25px; display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                        <div class="input-group">
                            ...
                            <textarea id="recipe-steps" class="input-field" style="height: 100px;" placeholder="Describe el proceso..."></textarea>
                        </div>
                        <div class="stat-card" style="background: #fdf2f8; border: 1px solid #fbcfe8;">
                            <h4 style="color: #9d174d; margin-bottom: 10px;">Análisis Financiero</h4>
                            <div style="display: flex; justify-content: space-between; margin-bottom: 5px;">
                                <span>Costo de Producción:</span>
                                <span id="summary-total-cost" style="font-weight: bold;">$0.0000</span>
                            </div>
                            <div style="display: flex; justify-content: space-between; margin-bottom: 5px;">
                                <span>Tasa BCV del día:</span>
                                <span id="summary-bcv-rate" style="color: #64748b;">0.00 Bs</span>
                            </div>
                            <div style="display: flex; justify-content: space-between; padding-top: 10px; border-top: 1px dashed #f9a8d4; margin-top: 10px;">
                                <span style="font-weight: bold;">Margen Sugerido (30%):</span>
                                <span id="summary-suggested-price" style="font-weight: bold; color: #be185d;">$0.00</span>
                            </div>
                        </div>
                    </div>

                    <div style="margin-top: 30px; display: flex; gap: 15px;">
                        <button id="btn-save-recipe" class="btn-primary" style="flex: 2;">Guardar Receta Profesional</button>
                        <button id="btn-cancel-form" class="btn-primary" style="background: #64748b; flex: 1;">Cancelar</button>
                    </div>
                </div>
            </div>
        </div>
